...
\And Gregor Kastner\\[.3em]WU Vienna University\\[-.1em]of Economics and Business}
...
\Address{
  ...
  1020 Vienna, Austria\\
  E-mail: \email{darjus.hosszejni@wu.ac.at}, \email{gregor.kastner@wu.ac.at}\\
  URL: \url{http://statmath.wu.ac.at/~hosszejni/}, \url{http://statmath.wu.ac.at/~kastner/}
}
