...
namespace stochvol {
    ...
    inline void update_svl(const arma::vec& y, const arma::vec& y_star, const arma::ivec& d, double& phi, double& rho, double& sigma2, double& mu, arma::vec& h, arma::vec& ht, Adaptation& adaptation_proposal, const arma::vec& prior_phi, const arma::vec& prior_rho, const arma::vec& prior_sigma2, const arma::vec& prior_mu, const bool use_mala, const bool gammaprior, const bool correct, const arma::ivec& strategy, const bool dontupdatemu) {
        typedef void(*Update_svl)(const arma::vec&, const arma::vec&, const arma::ivec&, double&, double&, double&, double&, arma::vec&, arma::vec&, Adaptation&, const arma::vec&, const arma::vec&, const arma::vec&, const arma::vec&, const bool, const bool, const bool, const arma::ivec&, const bool);
        ...
        {
            p_update_svl(y, y_star, d, phi, rho, sigma2, mu, h, ht, adaptation_proposal, prior_phi, prior_rho, prior_sigma2, prior_mu, use_mala, gammaprior, correct, strategy, dontupdatemu);
        }
    }
