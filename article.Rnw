...
<<homo, echo=TRUE, fig.width=7.5, fig.height=6>>=
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\textwidth]{Figures/jss2014-homo-1}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=.984\textwidth]{extrafig/predlik1}
\end{center}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=.984\textwidth]{extrafig/predlik3}
\end{center}
