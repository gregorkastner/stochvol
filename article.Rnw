...
\section*{Preface}
This vignette corresponds to an article of the same name which is published in the Journal of Statistical Software. The code base of the vignette has been updated to reflect the changes in recent versions of \stochvol{}. To cite, please use \cite{kas:dea}. Further information about citing \pkg{stochvol} can be obtained in \proglang{R} by installing the package, e.g., through \code{install.packages("stochvol")}, and calling \code{citation("stochvol")}.
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd1}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd2}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd3}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd4}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd5}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd6}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd7}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-usd8}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\textwidth]{Figures/jss2014-homo}
...
\begin{figure}[!ht]
 \begin{center}
\includegraphics[width=\textwidth]{Figures/jss2014-hetero}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-scatter}
\end{center}
...
\begin{figure}[!ht]
\begin{center}
 \includegraphics[width=\textwidth]{Figures/jss2014-betapost}
...
\begin{figure}[!ht]
 \begin{center}
  \includegraphics[width=\textwidth]{Figures/jss2014-qqplot}
 \end{center}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=.984\textwidth]{Figures/jss2014-predlik1}
\end{center}
...
\begin{figure}[!htp]
\begin{center}
 \includegraphics[width=.984\textwidth]{Figures/jss2014-predlik3}
\end{center}
