  ...
  switch (expert.proposal_sigma2) {
    ...
    case ExpertSpec_FastSV::ProposalSigma2::INDEPENDENCE: {
      switch (prior_spec.sigma2.distribution) {
        ...
        break;
        default:
        Rcpp::stop("Constant prior for sigma not implemented in fast sv.");
      }
    }
  }
...
std::pair<bool, double> sample_phi(
  ...
  switch (expert.proposal_phi) {
    ...
    break;
    default:
      Rcpp::stop("sample_phi: Mistake in the switch-case");
  }
...
double theta_log_likelihood(
  ...
  switch (centering) {
    ...
    case Parameterization::NONCENTERED:
      ...
      break;
    default:
      Rcpp::stop("theta_log_likelihood: Mistake in the switch-case");
  }
  return result;
}
...
double theta_log_prior(
  ...
  switch (prior_spec.mu.distribution) {
    ...
    case PriorSpec::Mu::NORMAL:
      ...
      break;
    default:
      Rcpp::stop("theta_log_prior: Mistake in the switch-case");
  }
  double phi_density;
