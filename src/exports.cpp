...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type stdev_mala(stdev_malaSEXP);
    Rcpp::traits::input_parameter< const bool >::type gammaprior(gammapriorSEXP);
...
static int _stochvol_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("void(*update_svl)(const arma::vec&,const arma::vec&,const arma::ivec&,double&,double&,double&,double&,arma::vec&,arma::vec&,const arma::vec&,const arma::vec&,const arma::vec&,const arma::vec&,const arma::mat&,const arma::mat&,const bool,const double,const bool,const bool,const arma::ivec&,const bool)");
    }
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_stochvol_svlsample_cpp", (DL_FUNC) &_stochvol_svlsample_cpp, 28},
