...
svlsample_cpp <- function(y, draws, burnin, X, thinpara, thinlatent, thintime, theta_init, h_init, prior_phi_a, prior_phi_b, prior_rho_a, prior_rho_b, prior_sigma2_shape, prior_sigma2_rate, prior_mu_mu, prior_mu_sigma, prior_beta_mu, prior_beta_sigma, verbose, offset, cov.mh, use.mala, stdev.mala, gammaprior, correct, strategy, dontupdatemu) {
    .Call(`_stochvol_svlsample_cpp`, y, draws, burnin, X, thinpara, thinlatent, thintime, theta_init, h_init, prior_phi_a, prior_phi_b, prior_rho_a, prior_rho_b, prior_sigma2_shape, prior_sigma2_rate, prior_mu_mu, prior_mu_sigma, prior_beta_mu, prior_beta_sigma, verbose, offset, cov.mh, use.mala, stdev.mala, gammaprior, correct, strategy, dontupdatemu, PACKAGE = "stochvol")
}
